                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-2">
                                        <img :src="profile_picture" class="update-img">
                                    </div>
                                    <div class="col-md-8">
                                        <input type="file" v-on:change="onFileChange"  name="profile_picture" id="profile_picture" placeholder="profile picture"  class="form-control-file">
                                    </div>
                ...
                axios.post('/assignments', {
                    ...
                    .catch(error => {
                        ...
                        if (error.response.data.errors.date_of_birth) {
                            this.errors.push(error.response.data.errors.date_of_birth[0]);
                        }
                        if (error.response.data.errors.biography) {
                            this.errors.push(error.response.data.errors.biography[0]);
                        }
                        if (error.response.data.errors.profile_picture) {
                            this.errors.push(error.response.data.errors.profile_picture[0]);
                        }
                    });
            },
            reset()
